...
registry.category("web_tour.tours").add("reception_tour", {
    url: "/odoo",
    steps: () => [
        stepUtils.showAppsMenuItem(),
        {
            trigger: '.o_app[data-menu-xmlid="visitor_management.reception_menu_root"]',
            content: _t(
        ...
        {
            trigger: '.dropdown-item[data-menu-xmlid="visitor_management.reception_menu_visitors"]',
