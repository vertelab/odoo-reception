...
class reception(http.Controller):
    ...
    def launch_reception(self, reception_id, token, lang='en_US'):
    ...
    @http.route('/reception/<int:reception_id>/<string:token>/get_reception_data', type='json', auth='public')
    ...
    @http.route('/reception/<int:reception_id>/<string:token>/get_planned_visitors', type='json', auth='public')
    ...
    @http.route('/reception/<int:reception_id>/background', type='http', auth='public')
    ...
    @http.route('/reception/<int:reception_id>/<string:token>/get_hosts', type='json', auth='public')
    ...
    @http.route('/reception/<int:reception_id>/<string:token>/prepare_visitor_data', type='json', auth='public', methods=['POST'])
