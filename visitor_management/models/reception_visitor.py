...
class ResPartner(models.Model):
    ...
    visit_ids = fields.One2many(comodel_name='reception.visitor',inverse_name='partner_id',string="Visits",)


class ReceptionVisitor(models.Model):
    _name = 'reception.visitor'
    ...
    partner_id = fields.Many2one(comodel_name='res.partner',string="Partner",help="Visiting partner") 
    ...
    def _notify(self):
        """ Send a notification to the visitor's responsible users and the visitor's hosts when the visitor checks in. """
        for visitor in self:
            msg = ""
